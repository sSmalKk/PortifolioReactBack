...
async function seedRouteRole () {
  try {
    const routeRoles = [ 
      ...
      {
        route: '/admin/lang/addbulk',
        role: 'System_User',
        method: 'POST' 
      },
      {
        route: '/admin/lang/list',
        role: 'System_User',
        method: 'POST' 
      },
      {
      ...
      {
        route: '/admin/lang/count',
        role: 'System_User',
        method: 'POST' 
      },
      {
        route: '/admin/lang/update/:id',
        role: 'System_User',
        method: 'PUT' 
      },
      {
        route: '/admin/lang/partial-update/:id',
        role: 'System_User',
        method: 'PUT'
      },
      {
        route: '/admin/lang/updatebulk',
        role: 'System_User',
        method: 'PUT' 
      },
      {
        route: '/admin/lang/softdelete/:id',
        role: 'System_User',
        method: 'PUT'
      },
      {
        route: '/admin/lang/softdeletemany',
        role: 'System_User',
        method: 'PUT'
      },
      {
        route: '/admin/lang/delete/:id',
        role: 'System_User',
        method: 'DELETE'
      },
      {
        route: '/admin/lang/deletemany',
        role: 'System_User',
        method: 'POST'
      },
      {
